...
public class ProductMatchesViewModel {
    ...
    public ProductMatchesViewModel(int id, String description, String price, String imageUrl, String averageRating, String ratingCount, Boolean isAddedToFavorite, String food, String title, String score, String link) {
        this.id = id;
